...
> It allows you to easily define Domain Specific Languages (DSL), with you own keywords and identifiers.
>
> Scheme is a classic academic LISP from MIT, and Racket a scholar's attempt to make LISP even more universally learnable (Logo is another well-known).
